...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_arm_aansturing-msg:<FibonacciGoal> is deprecated: use robot_arm_aansturing-msg:FibonacciGoal instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <FibonacciGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_arm_aansturing-msg:order-val is deprecated.  Use robot_arm_aansturing-msg:order instead.")
  (order m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FibonacciGoal>)))
  ...
  "robot_arm_aansturing/FibonacciGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FibonacciGoal)))
  "Returns string type for a message object of type 'FibonacciGoal"
  "robot_arm_aansturing/FibonacciGoal")
