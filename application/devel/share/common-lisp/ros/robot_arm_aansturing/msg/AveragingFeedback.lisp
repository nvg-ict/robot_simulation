...
(cl:defmethod cl:initialize-instance :after ((m <AveragingFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AveragingFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_arm_aansturing-msg:<AveragingFeedback> is deprecated: use robot_arm_aansturing-msg:AveragingFeedback instead.")))

(cl:ensure-generic-function 'sample-val :lambda-list '(m))
(cl:defmethod sample-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_arm_aansturing-msg:sample-val is deprecated.  Use robot_arm_aansturing-msg:sample instead.")
  (sample m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_arm_aansturing-msg:data-val is deprecated.  Use robot_arm_aansturing-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AveragingFeedback>)))
  ...
  "robot_arm_aansturing/AveragingFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AveragingFeedback)))
  "Returns string type for a message object of type 'AveragingFeedback"
  "robot_arm_aansturing/AveragingFeedback")
