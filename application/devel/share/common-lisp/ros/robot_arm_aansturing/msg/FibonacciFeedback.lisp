...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_arm_aansturing-msg:<FibonacciFeedback> is deprecated: use robot_arm_aansturing-msg:FibonacciFeedback instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_arm_aansturing-msg:sequence-val is deprecated.  Use robot_arm_aansturing-msg:sequence instead.")
  (sequence m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FibonacciFeedback>)))
  ...
  "robot_arm_aansturing/FibonacciFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FibonacciFeedback)))
  "Returns string type for a message object of type 'FibonacciFeedback"
  "robot_arm_aansturing/FibonacciFeedback")
